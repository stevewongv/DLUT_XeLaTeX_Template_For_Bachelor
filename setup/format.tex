...
% 缩小目录中各级标题之间的缩进
\dottedcontents{chapter}[0.32cm]{\vspace{0.2em}}{1.0em}{3pt}
\dottedcontents{section}[1.32cm]{}{1.8em}{3pt}
\dottedcontents{subsection}[2.32cm]{}{2.7em}{3pt}
\dottedcontents{subsubsection}[3.32cm]{}{3.4em}{3pt}
    ...
    \begin{center}
      ...
      \parbox[b][10.39cm][c]{\textwidth}
      {
        ...
        \begin{center}
          {
            \xiaosan\song
            \begin{tabular}{p{0.6cm}p{5.4em}  @{\extracolsep{0.5em}}lc}
              \vspace{-0.41cm} 
              ~ & 学 \hfill 院 \hfill （系）：& \fixedunderlineleft[6.08cm] {\@department} & \\
              \vspace{-0.41cm}
              ...
              \vspace{-0.41cm}
              ~ & 评 \hfill 阅 \hfill 教 \hfill 师：& \fixedunderlineleft[6.08cm]{\@teacher} & \\
              \vspace{-0.41cm}
...
\def\makeabstract{
  ...
  \noindent {\hei\textbf{{关键词：{\fs\@ckeywords}}}}
...
%  \cleardoublepage
  ...
  \noindent {\textbf{Key Words:}}~~{\textbf{\@ekeywords}}
  \cleardoublepage
}
